...
const statusStyles: Record<KanbanStatus, React.CSSProperties> = {
  ...
  pedido_fechado:  { background: "rgba(16, 185, 129, 0.12)", border: "1px solid rgba(16, 185, 129, 0.28)", color: "#6ee7b7" },
  venda_concluida: { background: "rgba(16, 185, 129, 0.15)", border: "1px solid rgba(16, 185, 129, 0.35)", color: "#6ee7b7" },
              ...
              {Array.from({ length: Math.min(totalPages, 5) }, (_, i) => {
                ...
                return (
                  <button
                    ...
                    style={
                      page === p
                        ? { background: "#10b981", color: "#fff", boxShadow: "0 0 10px rgba(57,217,138,0.20)" }
