      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-1.5">
            <Wifi className={cn("w-3 h-3", realtimeOk ? "text-[#6ee7b7]" : "text-muted-foreground")} />
            <span className={cn("text-xs", realtimeOk ? "text-[#6ee7b7]" : "text-muted-foreground")}>
        ...
        <div className="flex p-2 gap-1" style={{ borderBottom: "1px solid rgba(255, 255, 255, 0.09)" }}>
          {(["all", "ativa", "pausada", "concluida"] as const).map((f) => (
            <button
              ...
              style={filter === f ? { background: "#10b981", boxShadow: "0 0 10px rgba(57,217,138,0.20)" } : undefined}
            >
