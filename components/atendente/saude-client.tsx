      ...
      <div className="tec-panel p-6">
        <div className="flex items-start gap-4 flex-wrap">
            ...
            <div className="flex items-center gap-3 flex-wrap">
              ...
              <Badge
                className={cn(
                  "text-xs border",
                  agentActive
                    ? "bg-[#6ee7b7]/15 text-[#6ee7b7] border-[#6ee7b7]/20"
              ...
              >
                <span
                  className={cn(
                    ...
                    agentActive ? "bg-[#6ee7b7] animate-pulse" : "bg-red-400"
                  )}
                />
          ...
          <Button
            ...
            className={cn("gap-2 cursor-pointer shrink-0", !agentActive && "bg-[#10b981] hover:bg-[#18a966]")}
          >
