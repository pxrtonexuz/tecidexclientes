...
export default function SaudePage() {
  ...
  async function toggleAgent() {
    setToggling(true);
    await new Promise((r) => setTimeout(r, 600)); // TODO: UPDATE agent_config SET active = !active in Supabase
    setAgentActive((v) => !v);
    setToggling(false);
  }
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="flex-1 space-y-1">
            ...
            <div className="flex flex-wrap gap-4 text-sm text-muted-foreground">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <span>Última atividade: <span className="text-foreground font-medium">{format(new Date(2025, 3, 24, 14, 37), "dd/MM/yyyy 'às' HH:mm", { locale: ptBR })}</span></span>
              </div>
            </div>
          </div>
          <Button
      ...
      {/* TODO: Notificação push quando score < 70 */}
    </div>
  );
}
